...
const PROFILES = [
  {
    ...
    plan: {
      sayma:           { modes: ['counting', 'ordinalCount', 'counterFromN', 'quantityMatch'], acc: [0.78, 0.96], rt: [4200, 2700], hint: [0.6, 0.1], weight: 3, errors: { off_by_one: 0.7, random: 0.3 } },
      subitizing:      { modes: ['subitizing', 'fivesFrame', 'tensFrame', 'doubleTensFrame'], acc: [0.76, 0.94], rt: [3200, 2000], hint: [0.5, 0.1], weight: 2, errors: { off_by_one: 0.6, magnitude: 0.2, random: 0.2 } },
      karsilastirma:   { modes: ['comparison', 'lessMoreEqual', 'ordering', 'conservation'], acc: [0.74, 0.94], rt: [4500, 2900], hint: [0.8, 0.2], weight: 3, errors: { sign_error: 0.5, off_by_one: 0.3, random: 0.2 } },
  ...
  },
  {
    ...
    numap: null,
    plan: {
      sayma:         { modes: ['counting', 'quantityMatch', 'ordinalCount'], acc: [0.60, 0.85], rt: [6500, 4600], hint: [1.8, 0.7], weight: 3, errors: { off_by_one: 0.7, random: 0.3 } },
      ...
      karsilastirma: { modes: ['lessMoreEqual', 'comparison', 'matching'], acc: [0.50, 0.72], rt: [6000, 4500], hint: [1.6, 0.9], weight: 2, errors: { sign_error: 0.6, off_by_one: 0.2, random: 0.2 } },
  ...
  },
  {
    ...
    plan: {
      ...
      subitizing:      { modes: ['subitizing', 'tensFrame', 'doubleTensFrame', 'makeTen'], acc: [0.86, 0.96], rt: [2800, 2000], hint: [0.3, 0.1], weight: 2, errors: { off_by_one: 0.7, random: 0.3 } },
      karsilastirma:   { modes: ['ordering', 'comparison', 'lessMoreEqual', 'numberLineEstimate', 'nlPlacement'], acc: [0.82, 0.93], rt: [4000, 3000], hint: [0.5, 0.2], weight: 2, errors: { off_by_one: 0.5, magnitude: 0.2, random: 0.3 } },
