...
const GUIDING_QUESTIONS = {
  ...
  conservation:  ["Yerleri değişti — sayı da değişti mi? Say ve bak!"],
  ...
  fivesFrame:    ["Beşlik çerçevede dolu kutu kaç?", "Boş kutuları say, 5'ten çıkar!"],
  ...
  estimateCount: ["Küçük gruba bak. Kaç tane böyle grup var?", "Yaklaşık kaç tane?"],
  ...
  numberLineEstimate: ["Sayı doğrusunda nereye düşer?", "Ortası neresi?"],
...
const GUIDING_QUESTIONS_KU = {
  ...
  conservation:  ["Cihên wan guherîn — hejmar jî guherî? Bijmêre û binêre!"],
  ...
  fivesFrame:    ["Di çarçoveya pêncan de çend qutî tijî ne?", "Qutiyên vala bijmêre, ji 5'an kêm bike!"],
  ...
  estimateCount: ["Li koma biçûk binêre. Çend komên wisa hene?", "Bi qasî çend heb?"],
  ...
  rodSplit:      ["Tu dikarî kapsulê ji ku ve bibirî?", "Bi çend awayên cuda dikarî veqetînî?"],
