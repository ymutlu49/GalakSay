...
export const MODE_STORIES = {
  ...
  rodBack: { mission: "Hafıza Şimşeği!", story: "Yıldız taşlarını farklı biçimlerde gör — enerji kapsülü, çerçeve, domino, parmak — ve aklında tut!", briefing: "Aynı sayıyı farklı gösterimlerde tanı!", completion: "Çoklu temsil yeteneğin gelişti!", alienEncounter: "Şimşeron'un şekil değiştiricisi aynı sayıyı üç farklı biçimde gösteriyor.", strategyTip: "Her gösterim aynı miktarı anlatır — parmak, kapsül, çerçeve hepsi aynı sayıdır.", wrongInsight: "Gösterimi değil, yıldız taşlarının sayısını düşün — şekil değişse de miktar aynı kalır." },
  ...
  tensFrame: { mission: "Onluk Radar!", story: "Üst sıra doluysa 5! Sonra alt sıradakileri ekle — saymadan yapılandır!", briefing: "Üst sıra 5, alt sırayı ekle — toplam kaç?", completion: "Onluk radar kalibre edildi!", alienEncounter: "Şimşeron'un baykuşu Bakışık 10'luk çerçeveyi tarıyor — '5 üstte, altta kaç var?' diye soruyor.", strategyTip: "Üst sıra tam doluysa zaten 5. Alt sıradakileri ekle: 5 + alt sıra = toplam.", wrongInsight: "Üst sırayı 5 olarak kabul et, sadece alt sıradaki yıldız taşlarını say ve 5'e ekle." },
  doubleTensFrame: { mission: "Çift Onluk Radar!", story: "Sol çerçeve tam 10! Sağdakileri ekle — 10 artı kaç?", briefing: "Sol çerçeve 10, sağdakileri ekle!", completion: "Çift radar sistemi aktif!", alienEncounter: "Şimşeron'un ikiz pilotları birer çerçeve tutuyor — 'Solu biz doldurduk, sağı sen say!' diyorlar.", strategyTip: "Sol çerçeve 10. Sağ çerçevedeki yıldız taşlarını say ve 10'a ekle.", wrongInsight: "Sol çerçeve her zaman 10. Sadece sağ çerçevedekileri sayıp 10+? yap." },
  comparison: { mission: "Gezegen Düellosu!", story: "İki enerji kapsülünü karşılaştır — uzun olanda daha çok yıldız taşı var!", briefing: "İki kapsülü karşılaştır — hangisinde daha çok?", completion: "Karşılaştırma sistemi güncellendi!", alienEncounter: "Terazya'nın hakemi iki kapsülü tartıyor — 'Hangisi ağır?' diye soruyor.", strategyTip: "Kapsüllerin uzunluğuna bak — daha uzun kapsülde daha fazla yıldız taşı var.", wrongInsight: "Kapsülleri yan yana getir ve karşılaştır — hangisi daha uzun, o daha fazla." },
  ...
  trueFalse: { mission: "Denklem Dedektifi!", story: "Denklemi incele — iki taraf gerçekten aynı miktarda mı? Kozmik terazi dengede mi bak!", briefing: "Bu denklem doğru mu, yanlış mı?", completion: "Dedektiflik görevi başarılı!", alienEncounter: "Örünya'nın bukalemunu Dönüşçü kocaman bir terazi getiriyor — iki tarafı kontrol et!", strategyTip: "Her iki tarafı ayrı ayrı hesapla — sonuçlar aynıysa doğru, farklıysa yanlış.", wrongInsight: "Sol tarafı hesapla, sağ tarafı hesapla — iki sonuç eşitse doğru, değilse yanlış." },
  ...
  equalShare: { mission: "Galaktik Paylaşım!", story: "Herkese eşit dağıt — her grupta kaç tane olur?", briefing: "Herkese eşit dağıt — kaçar tane?", completion: "Adil paylaşım gerçekleşti!", alienEncounter: "Çarpanya'nın şefi Grupçu yıldız taşlarını herkese eşit dağıtıyor — 'Adaletli olmalı!' diyor.", strategyTip: "Her gruba birer tane ver, sonra tekrarla — herkes eşit alana kadar devam et.", wrongInsight: "Toplam ÷ grup sayısı = her gruba düşen miktar." },
...
export const MODE_STORIES_KU = {
  ...
  difference: { mission: "Mesafê Bipîve!", story: "Ferqa di navbera du hejmaran de bibîne — mesafê bipîve!", briefing: "Ferqa di navbera du hejmaran de bibîne!", completion: "Pîvana ferqê temam bû!", alienEncounter: "Endezyarê Kombûnyayê mesafa di navbera du gerstêrkan de dipîve — 'Ferqa di navberê de çiqas e?' dibêje.", strategyTip: "Ji hejmara biçûk heta hejmara mezin ber bi pêş bihejmêre — te çend gav avêt ferq ew e.", wrongInsight: "Her du hejmaran li tenişta hev deyne — ji ya mezin ya biçûk kêm bike an ji biçûk ber bi mezin bihejmêre." },
  ...
  wpCompare: { mission: "Erka Berhevkirinê!", story: "Du koman berhev bike, ferqê an ya mezin bibîne!", briefing: "Du koman berhev bike, ferqê bibîne!", completion: "Rapora berhevkirinê amade ye!", alienEncounter: "Heyvokên cêwî yên Kombûnyayê pêşbaziyê dikin — 'Ferqa di navbera me de çiqas e?' dibêjin.", strategyTip: "Peyvên wekî 'çend zêdetir', 'çend kêmtir', 'ferq' nîşana berhevkirinê ne.", wrongInsight: "Her du hejmaran li tenişta hev deyne — ji ya mezin ya biçûk kêm bike û ferqê bibîne." },
  ...
  trueFalse: { mission: "Detektîfê Hevkêşeyê!", story: "Hevkêşeyê vekole — gelo her du alî bi rastî bi qasî hev in? Binêre ka mêzîna kozmîk di hevsengiyê de ye!", briefing: "Ev hevkêşe rast e an çewt e?", completion: "Erka detektîfiyê bi serket!", alienEncounter: "Guherbarê Nimûneyayê mêzîneke mezin tîne — her du aliyan kontrol bike!", strategyTip: "Her aliyî cuda hesab bike — eger encam wekhev bin rast e, eger cuda bin çewt e.", wrongInsight: "Aliyê çepê hesab bike, aliyê rastê hesab bike — eger her du encam wekhev bin rast e, eger ne wekhev bin çewt e." },
  ...
  equalShare: { mission: "Parvekirina Galaktîk!", story: "Ji her kesî re wekhev par bike — di her komê de çend dikevin?", briefing: "Ji her kesî re wekhev par bike — çend bi çend?", completion: "Parvekirina dadmend pêk hat!", alienEncounter: "Serşêfê Carcaryayê Heştpê kevirên stêrkan ji her kesî re wekhev par dike — 'Divê dadmend be!' dibêje.", strategyTip: "Ji her komê re yek bide, paşê dubare bike — heta her kes wekhev distîne bidomîne.", wrongInsight: "Giştî ÷ hejmara koman = mîqdara ku dikeve her komê." },
  ...
  spaceBalance: { mission: "Mêzîna Fezayê!", story: "Her du aliyan hevseng bike — têgeha wekheviyê keşf bike!", briefing: "Her du aliyên mêzînê hevseng bike!", completion: "Hevsengî hat saz kirin!", alienEncounter: "Pasvanê mêzînê yê Nimûneyayê dixwaze her du kefî wekhev bin — 'Divê hevsengî were saz kirin!' dibêje.", strategyTip: "Divê her du aliyên nîşana wekheviyê di heman nirxê de bin — aliyê kêm temam bike.", wrongInsight: "Aliyê çepê bihejmêre, aliyê rastê bihejmêre — heke wekhev nebin ya kêm bibîne û zêde bike." },
...
export const CAPTAINS_LOG = {
  ...
  milestones: {
    ...
    levelMax: "Seviye 5 — Usta! Sayılar artık dost!",
...
export const MISSION_ARC = {
  ...
  chapters: [
    ...
    },
    {
      ...
      completionScene: "Galaksinin matematik motoru yeniden çalışıyor! Yıldızlar parlamaya, gezegenler dönmeye, nebulalar renklere boyanmaya başlıyor. Kaptan Bora gülümsüyor: 'Sen olmasaydın, galaksi karanlığa gömülürdü. Sen artık bir Galaktik Deha'sın!'",
    },
  ],
...
export const CAPTAINS_LOG_KU = {
  milestones: {
    ...
    allBadges: "Hemû nîşan hatin wergirtin! Dehaya Galaktîk!",
    ...
    levelMax: "Ast 5 — Hosta! Hejmar êdî heval in!",
