...
export const CATEGORIES = {
  ...
  level1: { name: "🌍 Sayalon", desc: "Sayma gezegenini keşfet!", learnKey: "level1", modes: {
    ...
    quantityMatch: { n: "Yıldız Taşı Eşle!", i: "🎲", d: "Yıldız taşlarını say, doğru rakamla eşle",       c: "#0891b2" },
    counting:      { n: "Yıldız Taşı Say!", i: "🔢", d: "Tek tek sayarak toplamı bul",                c: _C.blue },
    buildNumber:   { n: "Yıldız Taşlarını Yerleştir!", i: "🔨", d: "Söylenen sayı kadar yıldız taşı yerleştir", c: "#d97706" },
    ...
    decadeCount:   { n: "Onluk Geçişi!",   i: "🌉", d: "29'dan 30'a, 39'dan 40'a doğru sayabil",     c: "#9333ea" },
  ...
  level2: { name: "⚡ Şimşeron", desc: "Bir bakışta gör, şimşek hızında!", learnKey: "level7", modes: {
    fivesFrame:    { n: "Beşlik Radar!",   i: "5️⃣", d: "5'lik çerçevenin yapısıyla miktarı hızlı tanı",  c: "#4f46e5" },
    subitizing:    { n: "Işık Hızı!",      i: "⚡", d: "Saymadan bir bakışta kaç tane olduğunu söyle", c: "#7c3aed" },
    tensFrame:     { n: "Onluk Radar!",    i: "🔟", d: "10'luk çerçeve yapısıyla (5+5) miktarı tanı", c: "#7c3aed" },
    ...
    doubleTensFrame:{ n: "Çift Onluk Radar!",i: "🔟🔟",d: "Çift 10'luk çerçevede 11-20 arası say",     c: "#6d28d9" },
  ...
  level3: { name: "⚖️ Terazya", desc: "Denge ve düzen gezegeni", learnKey: "level2", modes: {
    ...
    beforeAfter:   { n: "Yörünge Komşusunu Bul!", i: "↔️", d: "Bir sayının önceki ve sonraki komşusunu bul", c: "#0d9488" },
    ...
    lengthGuess:   { n: "Gizli Nebula!",    i: "📏", d: "Kapsülün uzunluğuna bakarak sayısını tahmin et", c: "#6d28d9" },
  }},
  ...
  level4: { name: "🧱 Bileşya", desc: "Sayı bağlarını keşfet!", learnKey: "level3", modes: {
    ...
    partWhole:        { n: "Parça-Bütün Yapbozu!", i: "🧩", d: "Bütünü tamamlamak için eksik parçayı bul", c: _C.purple },
    ...
    spaceKitchen:     { n: "Uzay Mutfağı!",     i: "🧪", d: "Kapsülleri seç, hedef sayıyı oluştur — birden fazla yol var!", c: "#b45309" },
    rodSplit:         { n: "İkili Görev!",       i: "✂️", d: "Kapsülü kes, sayıyı bölmenin tüm yollarını bul!", c: "#7c2d12" },
  }},
  ...
  level5: { name: "🌗 Toplarya", desc: "Toplama-çıkarma yörüngesi", subGroups: true, modes: {
    ...
    addition:      { n: "Güçleri Birleştir!", i: "🧮", d: "Toplama stratejileri: çiftler, 10'a tamamla", c: _C.orange, grp: "toplama" },
    wpAdd:         { n: "Toplama Görevi!",   i: "📡", d: "Hikâye problemi: gruplar birleşir, toplamı bul", c: "#b45309", grp: "toplama" },
    ...
    wpSub:         { n: "Çıkarma Görevi!",   i: "📡", d: "Hikâye problemi: ayrılır, geriye kaç kalır?", c: "#991b1b", grp: "cikarma" },
    wpCompare:     { n: "Karşılaştırma Görevi!", i: "📡", d: "Hikâye problemi: hangisinde kaç fazla/eksik?", c: "#4338ca", grp: "cikarma" },
  }},
  ...
  level6: { name: "✖️ Çarpanya", desc: "Çarpma-bölme galaksisi", subGroups: true, modes: {
    ...
    wpMul:         { n: "Çarpma Görevi!", i: "📡", d: "Hikâye problemi: eşit gruplar, toplam kaç?",   c: "#7e22ce", grp: "carpma" },
    ...
    wpDiv:         { n: "Bölme Görevi!",  i: "📡", d: "Hikâye problemi: paylaştırma ve gruplama",     c: "#4338ca", grp: "bolme" },
  }},
...
/** Toplam mod sayısı — kullanıcıya görünen "N mod" metinleri bunu kullanır (elle yazılmış sayı yerine). */
export const MODE_COUNT = Object.values(CATEGORIES).reduce((n, c) => n + Object.keys(c.modes).length, 0);
...
const CAT_KU = {
  ...
  quantityMatch: { n: "Kevirên Stêrkan Hev Bike!", d: "Kevirên stêrkan bijmêre, bi reqemê rast re hev bike" },
  counting:      { n: "Kevirên Stêrkan Bijmêre!",     d: "Yek bi yek bijmêre û giştiyê bibîne" },
  buildNumber:   { n: "Kevirên Stêrkan Bi Cî Bike!", d: "Bi qasî jimara tê gotin kevirên stêrkan bi cî bike" },
  ordinalCount:  { n: "Keşfa Rêzê!",           d: "Çendemîn e? Yekem, duyem, sêyem..." },
  backwardCount: { n: "Jimartina Paşverû!",      d: "Ji 20'î ber bi paş ve bijmêre: 20, 19, 18..." },
  counterFromN:  { n: "Ji Gerdûnê Bijmêre!",   d: "Ji her jimarê ber bi pêş an paş ve bijmêre" },
  ...
  beforeAfter:   { n: "Cîranê Gerîngehê Bibîne!",     d: "Cîranê berê û paşê yê jimarekê bibîne" },
  ...
  lengthGuess:   { n: "Nebula Veşartî!",       d: "Li gorî dirêjahiya kapsulê jimara wê texmîn bike" },
  ...
  numbersInNumbers: { n: "Galaksiya Hejmaran!",  d: "Cota ku jimarekê çêdike bibîne" },
  spaceKitchen:     { n: "Metbexa Fezayê!",      d: "Kapsulan hilbijêre, jimara armanc çêbike — gelek rê hene!" },
  rodSplit:         { n: "Peywira Cot!",         d: "Kapsulê kêm bike, hemû rêyên parkirina jimarê bibîne!" },
  ...
  addChips:      { n: "Kevirên Stêrkan Bike Yek!", d: "Du koman yek bike, giştî çend dibe?" },
  countOnAdd:    { n: "Ji Ya Mezin Bihejmêre!",     d: "Ji jimara mezin dest pê bike, bi qasî ya biçûk lê zêde bike" },
  addition:      { n: "Hêzan Bike Yek!",        d: "Stratejiyên zêdekirinê: cot, bo 10'î temam bike" },
  wpAdd:         { n: "Erka Zêdekirinê!",    d: "Pirsgirêka çîrokî: kom yek dibin, giştiyê bibîne" },
  removeChips:   { n: "Kevirên Stêrkan Veqetîne!", d: "Ji komekê veqetîne, çend dimîne?" },
  difference:    { n: "Mesafê Bipîve!",      d: "Ferqa di navbera du jimaran de bibîne" },
  subtraction:   { n: "Enerjiyê Ji Hev Veqetîne!",    d: "Stratejiyên kêmkirinê: paşve bijmêre, ji zêdekirinê bifikire" },
  inversePractice:{ n: "Berevajî Bifikire!",   d: "Zêdekirin û kêmkirin berevajiyê hev in" },
  wpSub:         { n: "Erka Kêmkirinê!",   d: "Pirsgirêka çîrokî: vediqete, çend dimîne?" },
  wpCompare:     { n: "Erka Berhevkirinê!", d: "Pirsgirêka çîrokî: di kîjanê de çend zêde/kêm e?" },
  ...
  wpMul:         { n: "Erka Carkirinê!",  d: "Pirsgirêka çîrokî: komên wekhev, giştî çend?" },
  ...
  wpDiv:         { n: "Erka Parkirinê!", d: "Pirsgirêka çîrokî: parvekirin û komkirin" },
